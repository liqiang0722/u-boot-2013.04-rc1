...
//static ulong gd->arch.timer_rate_hz;
...
//static unsigned long gd->arch.lastinc;
/* Monotonic incrementing timer */
//static unsigned long long gd->arch.timer_reset_value;
...
void __udelay(unsigned long usec)
{
	...
	tmo = (usec + 9) / 10;
	tmp = get_ticks() + tmo;	/* get current gd->arch.timer_reset_value */
